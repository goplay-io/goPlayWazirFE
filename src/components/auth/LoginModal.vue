<template>
  <Teleport to="body">
    <div
      ...
      class="login-modal-root login-modal-root--light"
      role="presentation"
      @keydown.esc="closeLoginModal"
    >
      <div class="login-modal-backdrop" aria-hidden="true" @click="closeLoginModal" />
      ...
      >
        <div class="login-modal-inner">
          <div class="auth-page-card">
            ...
            <button type="button" class="auth-page-back" :aria-label="t('common.back')" @click="closeLoginModal">
              <v-icon size="20">mdi-arrow-left</v-icon>
            </button>

            <AuthDownloadBanner variant="login" />

            <h1 id="login-modal-title" class="auth-page-heading">
            ...
            <form class="auth-page-form" @submit.prevent="handleLogin">
              <div class="auth-page-field">
                ...
                <button type="button" class="auth-page-link" @click="goToForgotPassword">
            ...
            <p class="auth-page-footer">
              ...
              <router-link to="/signup" @click="closeLoginModal">{{ t('auth.login.signupCta') }}</router-link>
            </p>
          </div>
        </div>
      </div>
...
const { isLoginModalOpen, loginModalRedirect, closeLoginModal } = useLoginModal()
